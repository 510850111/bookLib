...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <%--编写数据增加表单--%>
            <form action="<%=basePath%>pages/back/books/AdminServlet/insert" method="post" class="form-horizontal"
                  id="insertForm">
                <%--图书名称--%>
...
<script type="text/javascript" src="validate/books_insert.js"></script>
</body>
</html>
